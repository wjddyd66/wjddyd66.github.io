...
<img src="https://raw.githubusercontent.com/wjddyd66/wjddyd66.github.io/master/static/img/HandsOn/ICA/10.PNG"/><br>

우리는 식 <span>$X = AS$</span>에서 A를 Orthogonal Matrix로 정의하였으므로, 위의 그림에서 회전변환을 통하여 X를 추정할 수 있다.  

**하지만 위의 그림을 어떤 방향으로 돌려도 결국 같은 분포가 나오게 A를 추정할 수 없게 된다.**  <br>
