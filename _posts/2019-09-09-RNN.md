...
위의 식을 풀어서 쓰면 아래와 같다.  
<pre><span>$$ P(w_1, .., w_m) = P(w_m|w_1, .., w_{m-1})P(w_{m-1}|w_1, .., w_{m-2}) ... P(w_2|w_1)P(w_1) $$</span></pre>
...
<pre>$$P(w_1, .., w_m) = \prod_{t=1}^m P(w_t|w_1, ..., w_{t-1}) \approx \prod_{t=1}^m P(w_t|w_{t-2},w_{t-1})(CBOW Model)$$</pre>
...
<a href="https://wjddyd66.github.io/dl/NeuralNetwork-(5)-Others">Xavier 자세한 내용</a><br>
<br><br>
### 언어 Model 평가 방법
