...
<a href="https://wjddyd66.github.io/tensorflow/Tensorflow-Linear-Regression/">Linear Regression 자세한 내용</a>  
...
A\begin{bmatrix} v_1 & v_2 & ... & v_n  \end{bmatrix} \\
 = \begin{bmatrix} \lambda_1v_1 & \lambda_2v_2 & ... & \lambda_nv_n  \end{bmatrix} \\
= \begin{bmatrix} v_1 & v_2 & ... & v_n  \end{bmatrix}\begin{bmatrix} \lambda_1 & 0 & ... & 0 \\ 0 & \lambda_2 & ... & 0 \\ ... \\ 0 & 0 & ... & \lambda_n   \end{bmatrix}
\end{multline}
$$</p>
