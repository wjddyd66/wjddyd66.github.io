...
Docker 사전지식: <a href="https://wjddyd66.github.io/categories/#docker">Docker Category</a><br>
<a href="https://wjddyd66.github.io/docker/Docker(9)">클라우드를 사용한 Docker 실행 환경 구축</a> Post를 살펴보면 Kubernetes를 컨테이너 오케스트레이션의 하나라고 잠시 언급하였다.  
