...
5. BImage를 반복적인 Erode와 Dilate로 인하여 Noise제거 (<a href="https://wjddyd66.github.io/opencv/OpenCV(5)">erode, dilage 자세한 내용</a>)
...
#### ROI 선택 Method
자세한 내용:<a href="https://wjddyd66.github.io/opencv/OpenCV(3)">OpenCV-기본연산</a><br>
```python
class bbox_select():
    %matplotlib notebook
