...
```
Data 그려보기  
<div><img src="https://raw.githubusercontent.com/wjddyd66/wjddyd66.github.io/master/static/img/AI/44.PNG" height="100%" width="100%" /></div>
<br>
...
```
sco 그려보기  
<div><img src="https://raw.githubusercontent.com/wjddyd66/wjddyd66.github.io/master/static/img/AI/45.PNG" height="100%" width="100%" /></div>
<br>
...
```
<div><img src="https://raw.githubusercontent.com/wjddyd66/wjddyd66.github.io/master/static/img/AI/46.PNG" height="100%" width="100%" /></div>
<br>
...
```
<div><img src="https://raw.githubusercontent.com/wjddyd66/wjddyd66.github.io/master/static/img/AI/47.PNG" height="100%" width="100%" /></div>
<br>
...
<table class="table">
	...
	<tr>
		...
		<td>scipy.stats.mannwhitneyu(x, y, use_continuity=True, alternative=None)</td>
	</tr>
	<tr>
		<td>paired 2 sample</td><td>wilcoxon test</td>
		<td>scipy.stats.wilcoxon(x, y=None, zero_method='wilcox', correction=False, alternative='two-sided')</td>
	</tr>
	<tr>
		<td>more than 3samples</td><td>kruskal-wallis test</td>
		<td>scipy.stats.kruskal(*args, **kwargs)</td>
	</tr>
</tbody>
</table>
<br>
...
```
**정규성 확인 그래프**  
<div><img src="https://raw.githubusercontent.com/wjddyd66/wjddyd66.github.io/master/static/img/AI/48.PNG" height="100%" width="100%" /></div>
<br>
<hr>
