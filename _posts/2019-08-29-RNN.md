...
<p>$$\hat{y_t} = softmax(Vs_t) \text$$</p>
<p>$$\text{y_t: 시간 스텝 t 에서 실제 단어, \hat{y_t}: 예측값}$$</p>
...
**1. Parameter V**  
<p>$$\frac{\partial E_3}{\partial V} = \frac{\partial E_3}{\partial \hat{y+3}} \frac{\partial \hat{y_3}}{\partial V}$$</p>
<p>$$= \frac{\partial E_3}{\partial \hat{y+3}} \frac{\partial \hat{y_3}}{\partial z_3} \frac{\partial z_3}{\partial V} \text{z_3 = Vs_3}$$</p>
