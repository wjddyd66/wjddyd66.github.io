...
<div ><img src="https://t1.daumcdn.net/cfile/tistory/224EFA4656EF49B309" height="200" width="400" align="center"/></div><br>
```sql
...
<div><img src="https://t1.daumcdn.net/cfile/tistory/2418A25056EF4BA912" height="200" width="400" align="center"/></div><br>
```sql
select jikwon_name, buser_name from jikwon, buser where buser_num(+)=buser_no; 
-- 없는 값 null
select jikwon_name, buser_name from jikwon inner join buser on buser_num(+)=buser_no;
...
<div><img src="https://t1.daumcdn.net/cfile/tistory/232EF54356EF4DA123" height="200" width="400" align="center"/></div><br>
```sql
...
<div><img src="https://t1.daumcdn.net/cfile/tistory/251A374456EB994D13" height="200" width="400" align="center"/></div><br>
```sql
select jikwon_name, buser_name from jikwon, buser where buser_num=buser_no; 
